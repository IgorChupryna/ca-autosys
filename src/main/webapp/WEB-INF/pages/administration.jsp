...
<div class="container">
    ...
    <div w3-include-html=${administration.fullDesc}></div>
    <script>
        w3.includeHTML();
    </script>
</div>
...
<div class="container">
    ...
    <video width="480" height="320" controls>
        ...
        <source src=${administration.pathVideo} type="video/mp4">
    </video>
</div>
...
<div class="container">
    ...
    <div class="row">
        <div class='list-group gallery'>
            <c:forEach items="${administration.imgs}" var="list">
    ...
    <div class="chatContainer">
        ...
        <div class="chatHistoryContainer">
            <ul class="formComments">
                <c:forEach items="${administration.comments}" var="list" varStatus="myIndex">
                                    ...
                                    <div id="comment-${myIndex.index}" data-commentid="${myIndex.index}" class="comment comment-step1">${list.body}
                                        <c:if test="${login == list.user}">
                                            <div id="commentactions-${myIndex.index}" class="comment-actions">
                                                <form id="del" method="POST" action="/delComment?name=<c:out value="${administration.name}"></c:out>&id=<c:out value="${list.id}"></c:out>&table=Administration">
        ...
        <div class="input-group input-group-sm chatMessageControls">
            ...
            <form id="send" method="POST"
                  action="/addComment?name=<c:out value="${administration.name}"></c:out>&id=<c:out value="${administration.id}"></c:out>&table=Administration">
